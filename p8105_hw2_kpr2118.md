...
includes data for the range of years from 1947 - 2015 and key variables
are year, month, president (democrat or republican in office), close
(the closing value of S\&P stock index), and precent\_unemp (the
